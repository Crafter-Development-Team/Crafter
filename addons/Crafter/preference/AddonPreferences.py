...
# ========== 导入世界属性 ==========
    ...
    partitionSize: IntProperty(name="Chunk Side Length",
                               ...
                               default=4,
                               min=1)#type: ignore
    maxTasksPerBatch: IntProperty(name="Max Tasks per Batch",
                                  default=2048,
                                  min=1)# type: ignore
    ...
    LODCenterZ: IntProperty(name="LOD Center Z",
                            default=0)# type: ignore
    LOD0renderDistance: IntProperty(name="No LOD Distance",
                                   default=8,
                                   min=0)# type: ignore
...
# ========== 加载材质属性 ==========
    PBR_Parser: EnumProperty(name="PBR Parser",
                              items=[("lab_PBR_1.3","lab PBR 1.3","1-R,G as F0,Emission in Alpha"),
                                     ("old_PBR","old PBR","1-R,G as Metallic,Emission in B")],
                              default="lab_PBR_1.3",
